...
public class Wall extends GameObject {
    ...
    public Wall(float x, float y, Sprite sprite) {
        ...
        this.enemy_walking_bounds = createBoundsRectangle(x - (ENEMY_WALKING_BOUNDS_WALL_WIDTH*4), y + ENEMY_WALKING_BOUNDS_WALL_HEIGHT + ENEMY_WALKING_BOUNDS_WALL_HEIGHT/3, ENEMY_WALKING_BOUNDS_WALL_WIDTH, ENEMY_WALKING_BOUNDS_WALL_HEIGHT);
        this.sprite = sprite;
    }
}
