...
public class OrthogonalTiledMapRendererWithSprites extends OrthogonalTiledMapRenderer {
    ...
    private int treeSpritesLayer = 2;
        ...
        for (int row = row2; row >= row1; row--) {
            ...
            for (int col = col1; col < col2; col++) {
                ...
                if (tile != null) {
                    ...
                    addTrees(vertices[0], vertices[1], region.getTexture());
                }
                x += layerTileWidth;
            }
            y -= layerTileHeight;
    ...
    private void addTrees(float positionX, float positionY, Texture texture) {
        if(firstRender == 0) {
            World.treeList.add(new Tree(positionX, positionY, texture.getWidth(), texture.getHeight(), new Sprite(texture)));
            System.out.println("Tree positions " + positionX + "  " + positionY);
        }
    }
}