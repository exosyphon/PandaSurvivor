...
public class OrthogonalTiledMapRendererWithSprites extends OrthogonalTiledMapRenderer {
    ...
    public Sprite getSprite(Sprite sprite) {
        return sprites.get(sprites.indexOf(sprite));
    }
    ...
    public void render() {
        ...
        if (WorldRenderer.showGearStats) {
            ...
            WorldRenderer.equipmentStatsFont.draw(batcher, String.valueOf(item.getPhysicalBonus()), (WorldRenderer.w * .39f) - (String.valueOf(item.getPhysicalBonus()).length() * NUMBER_INCREMENT_OFFSET), (WorldRenderer.camera.viewportHeight - (WorldRenderer.h * .37f)));
        ...
        if (WorldRenderer.showCurrentGearStats) {
            ...
            if (item != null) {
                ...
                WorldRenderer.equipmentStatsFont.draw(batcher, String.valueOf(item.getPhysicalBonus()), (WorldRenderer.w * .947f) - (String.valueOf(item.getPhysicalBonus()).length() * NUMBER_INCREMENT_OFFSET), (WorldRenderer.camera.viewportHeight - (WorldRenderer.h * .37f)));
